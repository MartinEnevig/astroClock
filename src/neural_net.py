...
class NeuralClock:
    ...
    def make_model(self, training_data: np.ndarray) -> Model:
        ...
        dense_1 = Dense(units=24, kernel_initializer="he_normal", activation="relu")(normalized)
        dense_2 = Dense(units=24, kernel_initializer="he_normal", activation="relu")(dense_1)
        dense_3 = Dense(units=20, kernel_initializer="he_normal", activation="relu")(dense_2)
        dense_4 = Dense(units=20, kernel_initializer="he_normal", activation="relu")(dense_3)
        dense_5 = Dense(units=16, kernel_initializer="he_normal", activation="relu")(dense_4)
        dense_6 = Dense(units=12, kernel_initializer="he_normal", activation="relu")(dense_5)
        dense_7 = Dense(units=6, kernel_initializer="he_normal", activation="relu")(dense_6)
        dense_8 = Dense(units=4, kernel_initializer="he_normal", activation="relu")(dense_7)
        output_layer = Dense(units=2)(dense_8)
